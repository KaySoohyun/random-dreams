...
const base = (
  slug: string,
  data: Omit<CatalogProduct, "id" | "slug" | "active">
): CatalogProduct => ({
  id: slug,
  slug,
  active: true,
...
export const products: CatalogProduct[] = [
  base("souvenir-de-vida-paralela", {
  ...
  base("manual-de-contingencia-absurda", {
    name: "Manual Absurdo",
    tagline:
  ...
  base("identidad-secreta-de-epoca", {
...
export function getProductBySlugData(slug: string) {
