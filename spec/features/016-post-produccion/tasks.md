...
- [x] **Logo en el PDF**: el PDF usa `public/assets/logo_pdf.png` como header arriba del contenido (centrado, línea dorada); incrustado como data URI en `lib/pdf/markdown-pdf.tsx`; si falta el archivo, genera sin logo.
